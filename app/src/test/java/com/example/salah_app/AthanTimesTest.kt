...
class AthanTimesTest {
    ...
    fun BeforeFajrShouldReturnGiveFirstIndex() {
        val athanTimes = HashMap(SalatTimes(location = Location("TBD", 45.33, -75.33, 0.0, -4.0), calculationMethod = CalculationMethod.ISLAMIC_SOCIETY_OF_NORTH_AMERICA,
            dateTime = LocalDateTime.of(2021, Month.MAY, 8, 1, 30)).salatDateTimes)
    ...
    fun AfterFajrShouldReturnSecondIndex() {
        val athanTimes = HashMap(SalatTimes(location = Location("TBD", 45.33, -75.33, 0.0, -4.0), calculationMethod = CalculationMethod.ISLAMIC_SOCIETY_OF_NORTH_AMERICA,
            dateTime = LocalDateTime.of(2021, Month.MAY, 8, 7, 32)).salatDateTimes)
    ...
    @Test
    fun AfterMaghribShouldReturnSecondIndex() {
        val athanTimes = HashMap(SalatTimes(location = Location("TBD", 45.33, -75.33, 0.0, -4.0), calculationMethod = CalculationMethod.ISLAMIC_SOCIETY_OF_NORTH_AMERICA,
            dateTime = LocalDateTime.of(2021, Month.MAY, 8, 7, 32)).salatDateTimes)
